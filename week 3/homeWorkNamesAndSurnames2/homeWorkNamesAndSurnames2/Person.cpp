...
private:
    ...
    string getLastRecordBeforYear (const int& year, const map<int, string>& history) {
        string record = "";
    ...
    string reverceJoinVector(const vector<string>& vector, const string& delimiter) {
        string result = "";
    ...
    string createName (const string& firstName, const string& lastName) {
